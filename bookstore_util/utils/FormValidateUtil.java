...
public class FormValidateUtil {
     ...
     */
    public static final String MOBILE = "^(13[0-9]|14[0-9]|15[0-9]|18[0-9]|17[0-9])\\d{8}$";

    /**
     * 用户名 1-50位数字字母下划线汉字
     */
    public static final String NAME = "[\\u4e00-\\u9fa5\\w]{1,50}";
...
////------------------验证方法
    ...
    public static boolean isLengOut(String str, int leng) {
        return !isEmpty(str) && str.trim().length() > leng;
    }
     ...
     *
     * @param sysCode  原验证码
     * @param usrCode  用户输入验证码
     * @param isStrict 是否严格验证大小写
     * @return
     */
    public static boolean isCode(String sysCode, String usrCode,
                                 boolean isStrict) {
        return !(isEmpty(usrCode) || isEmpty(sysCode)) && (isStrict ? sysCode.equals(usrCode) : sysCode.equalsIgnoreCase(usrCode));
    }
