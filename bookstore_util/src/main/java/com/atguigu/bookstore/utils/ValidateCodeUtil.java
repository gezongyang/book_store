...
//
//import com.sdonkey.score.util.SendMessageUtil;
...
////            sb.append("<p>尊敬的用户【").append(name).append("】您好！<br /><br />此邮件旨在验证邮箱。").append("此次您的验证码为：<h1>").append(code).append("</h1><br/>").append("请注意：该验证码将在10分钟后过期，请尽快验证！。<br />").append("此为系统邮件，请勿回复。如有任何疑问或遇到问题，请发送电子邮件至 xiaomaolv@jifenguanggao.com获取我们的帮助。<br />").append("感谢您对积分平台的支持。<br /><br />").append("积分广告平台 支持中心</p>");
////            try {
////              SendMailNew.sendMailAsText1("北京火星小毛驴科技  邮箱验证", ConfigUtil.getString("sendMail"), userEmail, sb.toString());
////            } catch (Exception e) {
////                e.printStackTrace();
////                return -2;//邮件发送失败
////            }
